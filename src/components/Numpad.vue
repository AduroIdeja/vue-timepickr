  ...
  <div class="numpad">
    <div class="numpad__digits">
      <div class="numpad__digit" v-for="digit in numbers" :key="digit">
        ...
        <div class="numpad__ripple" :class="{ 'is-pressed': digit.pressed }"></div>
      </div>
    </div>
    <div class="numpad__arrows">
      <div class="numpad__digit">
        <button :class="{ 'is-disabled': activeIndex <= 0 }" :disabled="activeIndex <= 0" @click="goToPrevious()">&#9664;</button>
        <div class="numpad__ripple" :class="{ 'is-pressed': arrowKeys.left.pressed }"></div>
      </div>
      <div class="numpad__digit">
        <button class="numpad__digit" :class="{ 'is-disabled': activeIndex > 2 }" :disabled="activeIndex > 2" @click="goToNext()">&#9658;</button>
        <div class="numpad__ripple" :class="{ 'is-pressed': arrowKeys.right.pressed }"></div>
      </div>
    </div>
  </div>
</template>
